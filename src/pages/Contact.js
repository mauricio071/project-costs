...
function Contact() {
    ...
    function submit(e) {
        ...
        if (contact.name && contact.email && contact.description) {
    ...
    return (
        <div className={styles.contact_container}>
            ...
            <form onSubmit={submit} className={styles.form}>
                ...
                <Input type="text" text="Digite o seu email" name="email" placeholder="Digite o seu email" handleOnChange={handleChange} value={contact.email ? contact.email : ''} />
